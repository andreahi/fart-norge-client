 ...
 */
public class KdTreeOld<T extends KdTreeOld.XYZPoint> {
     ...
     *            of XYZPoints.
     */
    public KdTreeOld(List<XYZPoint> list) {
     ...
     */
    private static final <T extends KdTreeOld.XYZPoint> KdNode getNode(KdTreeOld<T> tree, T value) {
    ...
    private static final <T extends KdTreeOld.XYZPoint> void searchNode(T value, KdNode node, int K,
    ...
    public static class XYZPoint implements Comparable<XYZPoint> {
        ...
        private static final double euclideanDistance(XYZPoint o1, XYZPoint o2) {
        	...
        	Location.distanceBetween(o1.x, o1.y, o2.x, o2.y, results);
			return results[0];
        };
    ...
    protected static class TreePrinter {
        ...
        public static <T extends XYZPoint> String getString(KdTreeOld<T> tree) {
            if (tree.root == null)
